...
<html lang="en">
  ...
  <div class="collection_text">Productos</div>
    <div class="collection_section layout_padding">
    	<div class="container">
    		<h1 class="new_text"><strong>Bienvenidos a la sección de Productos de Pullo</strong></h1>
    	    <p class="consectetur_text">En Pullo, nos especializamos en ofrecer la mejor ropa deportiva para ayudarte a alcanzar tus metas. Nuestra colección abarca una amplia variedad de prendas diseñadas para proporcionar confort, estilo y rendimiento, ya sea que estés entrenando en el gimnasio, corriendo al aire libre o simplemente buscando ropa deportiva de calidad para el día a día.</p>
    	</div>
    </div>
          ...
          while ($reg = mysqli_fetch_array($datos)) {?>
    			...
    			<div class="col-sm-4">
    				<div class="best_shoes">
    					...
    					<div class="shoes_icon"><img src="data:image/jpg;base64, <?php echo base64_encode($reg['imagen'])?>" width="200px" height="200px"></div>
    					<div class="star_text">
    						<div class="left_part">
    							<ul>
    	    						<li><a href="producto.php?id=<?php echo $reg['id'];?>"><button class="btn btn-primary"  type="button" name="button">Ver producto</button></li>
    	    						<li><a href="#"></a></li>
    	    						<li><a href="#"></a></li>
    	    						<li><a href="#"></a></li>
    	    						<li><a href="#"></a></li>
    						...
    						<div class="right_part">
    							<div class="shoes_price"><span style="color: black;">$<?php echo $reg['precio']; ?></span></div>
    						</div>
    					</div>
    				</div>
    			</div>
