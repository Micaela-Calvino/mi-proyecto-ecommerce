...
<html lang="en">
  ...
  <!-- new collection section start -->
  <div class="collection_text">Buzos</div>
   <div class="about_main layout_padding">
    <div class="collection_section">
    	<div class="container">
    		<h1 class="new_text"></h1>
    	    <p class="consectetur_text">En Pullo, ofrecemos una amplia variedad de buzos deportivos diseñados para brindarte comodidad y estilo en todas tus actividades.tenemos lo que necesitas para mantenerte cómodo y a la moda durante tus entrenamientos y en tu día a día</p>
