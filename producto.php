    ...
    <div class="collection_section">
        ...
        <div class="col-sm-4">
          <div class="best_shoes">
            <p class="best_text"> <?php echo $marca; ?></p>
            <div class="shoes_icon"><img src="data:image/jpg;base64, <?php echo base64_encode($imagen)?>"></div>
            <div class="star_text">

              <div class="left_part">
                <h1>Talle: <?php echo $talle?></h1>
              </div>
              <div class="right_part">

                <div class="shoes_price"> <span style="color: #ff4e5b;">$<?php echo $precio; ?></span></div>
              </div>
            </div>
          </div>
      ...
      <div class="col-sm-4">
        <div class="best_shoes">
          <p class="best_text"><?php echo $marca; ?></p>
          <div class="shoes_icon"><img src="data:image/jpg;base64, <?php echo base64_encode($imagen2)?>"></div>
          <div class="star_text">
            <div class="left_part">
              <h1>Talle: <?php echo $talle?></h1>
        ...
        <div class="">
          <button class="seemore_bt"><a href="agregarCliente.php?id=<?php echo $datos['id'];?>" role="button">Comprar</a></button>
