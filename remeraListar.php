...
<html lang="en">
  ...
  <!-- new collection section start -->
  <div class="collection_text">Remeras</div>
   <div class="about_main layout_padding">
    <div class="collection_section">
    	<div class="container">
    		<h1 class="new_text"></h1>
    	    <p class="consectetur_text">En Pullo, ofrecemos una amplia variedad de remeras deportivas diseñados para brindarte comodidad y estilo en todas tus actividades.tenemos lo que necesitas para mantenerte cómodo y a la moda durante tus entrenamientos y en tu día a día</p>
          ...
          <div class="col-sm-4">
            <div class="best_shoes">
              ...
              <div class="star_text">
                ...
                <div class="left_part">
                  <h1>Talle: <?php echo $reg['talle']; ?></h1>
                </div>
